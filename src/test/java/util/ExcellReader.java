...
public class ExcellReader {
    /**
     * How do you work with Excel files? How do use it for automation?
     *
     *
     * This will use Apache POI libraries to create, read, write, and modify Excel files using Java
     *
